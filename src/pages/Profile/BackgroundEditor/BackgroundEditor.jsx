...
const BackgroundEditor = ({ image, setImage, originalImage, setUserData }) => {
    ...
    const handleImgChange = (e) => {
        ...
        const filePromise = new Promise((resolve, reject) => {
            if (acceptedFile.type.startsWith("image/")) {
                ...
                reject(new Error("Invalid file type. Please choose an image."));
            }
        });
    ...
    const handleSaveEditImage = async () => {
        try {
            ...
            const res = await userService.updateUserBackground(data);
            ...
            <Dialog.Portal>
                ...
                >
                    <div className="flex flex-col gap-2 overflow-auto w-full min-h-[600px] max-h-[1000px] relative">
                        ...
                        <div className="flex flex-col gap-[20px] mt-[50px] items-center">
